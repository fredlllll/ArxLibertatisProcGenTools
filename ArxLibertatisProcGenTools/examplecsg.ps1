...
#for some reason we have to specify CSG.dll seperately cause it randomly stopped working without this
Add-Type -Path "CSG.dll"

# set the data dir containing the unpacked game and graph directories
#[ArxLibertatisProcGenTools.ScriptFunc]::SetDataDir("C:\Program Files (x86)\Arx Fatalis")
...
#create the CSG Shape
$cube = [CSG.Shapes.Cube]::new([Vector3]::new(0, 0, 0), [Vector3]::new(1.4, 1.4, 1.4))
$sphere = [CSG.Shapes.Sphere]::new([Vector3]::new(0, 0, 0), 1)
$cylinder1 = [CSG.Shapes.Cylinder]::new([Vector3]::new(0, 1, 0), [Vector3]::new(0, -1, 0),0.5)
$cylinder2 = [CSG.Shapes.Cylinder]::new([Vector3]::new(1, 0, 0), [Vector3]::new(-1, 0, 0),0.5)
$cylinder3 = [CSG.Shapes.Cylinder]::new([Vector3]::new(0, 0, 1), [Vector3]::new(0, 0, -1),0.5)

$union = $cylinder1.Union($cylinder2.Union($cylinder3))
$intersect = $cube.Intersect($sphere)
$csgShape = $intersect.Subtract($union)
$csg = [CSGGenerator]::new()
$csg.CsgShape = $cylinder1
...
$pos = New-Object Vector3(6000,-300,6000)
